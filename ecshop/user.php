...
elseif ($action == 'act_register')
{
    ...
    else
    {
        ...
        // {
        //     echo $_LANG['passport_js']['username_shorter'];
        // }
    ...
    if (trim($username)!='') {
        if (trim($password)!='') {
            // if ($password==$password_confirm) {
                ...
                {
                    $_SESSION['login_fail'] ++ ;
                    echo $_LANG['login_failure'];
                    // show_message($_LANG['login_failure'], $_LANG['relogin_lnk'], 'user.php', 'error');
                }
            // } else {
            //     echo $_LANG['password_no_match'];
            //     // show_message($_LANG['password_no_match'], $_LANG['relogin_lnk'], 'user.php', 'error');
            // }
        } else {
            echo $_LANG['password_empty'];
        }
    } else {
