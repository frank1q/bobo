...
<div class="tab-div">
    ...
    <div id="tabbar-div">
      <p>
        ...
        <span class="tab-back" id="mix-tab"><?php echo $this->_var['lang']['tab_mix']; ?></span><?php if ($this->_var['goods_type_list']): ?>
        <span class="tab-back" id="properties-tab"><?php echo $this->_var['lang']['tab_properties']; ?></span><?php endif; ?>
        <span class="tab-back" id="gallery-tab"><?php echo $this->_var['lang']['tab_gallery']; ?></span>
        <span class="tab-back" id="linkgoods-tab"><?php echo $this->_var['lang']['tab_linkgoods']; ?></span><?php if ($this->_var['code'] == ''): ?>
        <span class="tab-back" id="groupgoods-tab"><?php echo $this->_var['lang']['tab_groupgoods']; ?></span><?php endif; ?>
...
?>
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_layer']; ?></td>
            <td>


              <select name="layer_type" id="layer_type">
                <option value="underwear-10" <?php if ($this->_var['goods']['layer_type'] == 'underwear'): ?>  selected="selected" <?php endif; ?> ><?php echo $this->_var['lang']['lab_underwear']; ?></option>
                <option value="trousers-50"  <?php if ($this->_var['goods']['layer_type'] == 'trousers'): ?>  selected="selected" <?php endif; ?> ><?php echo $this->_var['lang']['lab_trousers']; ?></option>
                <option value="coat-100"     <?php if ($this->_var['goods']['layer_type'] == 'coat'): ?>  selected="selected" <?php endif; ?> ><?php echo $this->_var['lang']['lab_coat']; ?></option>
              </select>  
            </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              <option value="0"><?php echo $this->_var['lang']['select_please']; ?><?php echo $this->html_options(array('options'=>$this->_var['brand_list'],'selected'=>$this->_var['goods']['brand_id'])); ?></option></select>
              <?php if ($this->_var['is_add']): ?>
...
?>
          ...
          <!--商品性别分类-->
          <tr>
            <td class="label"><?php echo $this->_var['lang']['category_sex']; ?></td>
            <td>
              <?php if ($this->_var['goods']['goods_sex'] == 1): ?>
                <input type="radio" name="goods_sex" value="0" /> <?php echo $this->_var['lang']['category_male']; ?>
                <input type="radio" name="goods_sex" value="1" checked="checked"/> <?php echo $this->_var['lang']['category_female']; ?>
              <?php else: ?>
                <input type="radio" name="goods_sex" value="0" checked="checked"/> <?php echo $this->_var['lang']['category_male']; ?>
                <input type="radio" name="goods_sex" value="1" /> <?php echo $this->_var['lang']['category_female']; ?>
              <?php endif; ?>
            </td>
          </tr>
          <!--商品性别分类 end -->
...
?>
          ...
          <tr>
            <td class="label"><?php echo $this->_var['lang']['lab_front_cover']; ?></td>
            <td>
              <input type="file" name="goods_front_cover" size="35" />
              <?php if ($this->_var['goods']['goods_front_cover']): ?>
                <a href="goods.php?act=show_image&img_url=<?php echo $this->_var['goods']['goods_front_cover']; ?>" target="_blank">
