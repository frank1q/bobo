...
=======
            <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_45360300_1420825423');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_45360300_1420825423']):
?>  
              <div class="item_fc">
                <a href="<?php echo $this->_var['goods_0_45360300_1420825423']['url']; ?>">
                  <img src="<?php echo $this->_var['goods_0_45360300_1420825423']['goods_thumb']; ?>" alt="" class="img-responsive"/>
                </a>
                <a href="<?php echo $this->_var['goods_0_45360300_1420825423']['url']; ?>"><?php echo $this->_var['goods_0_45360300_1420825423']['fittings_price']; ?></a>
