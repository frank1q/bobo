      ...
      <div class="item_footer">
        ...
        <div class="item_complete_con">
          <?php if ($this->_var['fittings']): ?>  
            <?php $_from = $this->_var['fittings']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_32528700_1420744448');if (count($_from)):
    foreach ($_from AS $this->_var['goods_0_32528700_1420744448']):
?>  
              <div class="item_fc">
                <a href="<?php echo $this->_var['goods_0_32528700_1420744448']['url']; ?>">
                  <img src="<?php echo $this->_var['goods_0_32528700_1420744448']['goods_thumb']; ?>" alt="" class="img-responsive"/>
                </a>
                <a href="<?php echo $this->_var['goods_0_32528700_1420744448']['url']; ?>"><?php echo $this->_var['goods_0_32528700_1420744448']['fittings_price']; ?></a>
              </div>
            <?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>  
          <?php endif; ?> 
        </div>
