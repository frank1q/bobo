...
function reformat_image_name($type, $goods_id, $source_img, $position='')
{
    ...
    if (!make_dir(ROOT_PATH.$dir.'/'.$sub_dir.'/goods_front_cover'))
    {
        return false;
    }
    if (!make_dir(ROOT_PATH.$dir.'/'.$sub_dir.'/front_cover_thumb'))
    {
        return false;
    }
    ...
    switch($type)
    {
        case 'goods':
            ...
            break;
        case 'front_cover':
            $img_name = $goods_id . '_thumb_F_' . $rand_name;
            break;
        case 'front_cover_thumb':
            $img_name = $goods_id . '_thumb_T_' . $rand_name;
            break;
        case 'goods_thumb':
    ...
    elseif ($position == 'thumb')
    {
     ...
     elseif ($position == 'front_cover')
    {
        if (move_image_file(ROOT_PATH.$source_img, ROOT_PATH.$dir.'/'.$sub_dir.'/goods_front_cover/'.$img_name.$img_ext))
        {
            return $dir.'/'.$sub_dir.'/goods_front_cover/'.$img_name.$img_ext;
        }
    }
    elseif ($position == 'front_cover_thumb')
    {
        if (move_image_file(ROOT_PATH.$source_img, ROOT_PATH.$dir.'/'.$sub_dir.'/front_cover_thumb/'.$img_name.$img_ext))
        {
            return $dir.'/'.$sub_dir.'/front_cover_thumb/'.$img_name.$img_ext;
        }
    }
    else
    {
