...
function insert_history()
{
    ...
    if (!empty($_COOKIE['ECS']['history']))
    {
        ...
        while ($row = $GLOBALS['db']->fetch_array($query))
        {
           ...
           $str.='<div class="item_fc"><a href="'.$goods['url'].'" target="_blank"><img src="'.$goods['goods_thumb'].'" alt="'.$goods['goods_name'].'" class="B_blue" /></a><a href="'.$goods['url'].'" target="_blank">'.$goods['shop_price'].'</a></div>';
        }
    }
    return $str;
}
