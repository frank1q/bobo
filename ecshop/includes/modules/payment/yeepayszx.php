...
$payment_lang = ROOT_PATH . 'languages/' .$GLOBALS['_CFG']['lang']. '/payment/yeepayszx.php';
...
class yeepayszx
{
    ...
    function hmac($data, $key)
    {
        ...
        $key  = ecs_iconv(EC_CHARSET, 'UTF8', $key);
        $data = ecs_iconv(EC_CHARSET, 'UTF8', $data);
